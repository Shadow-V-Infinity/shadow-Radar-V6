...
# Chemin vers ton fichier historique
HISTORY_FILE = Path("data/nba_history.csv")  # tu peux adapter
...
class NBAHistoryModel:
    ...
    def _build_team_stats(self):
        ...
        for g in self.games:
            ...
            stats[ta]["edge_sum"] += -edge  # on inverse côté away
    ...
    def get_matchup_edge(self, home: str, away: str) -> Optional[str]:
        ...
        return (
            ...
            f"→ Plus l’edge est élevé, plus {home} a dominé historiquement.\n"
        )
